...
var errorMsg = "<h3>Sorry, but this site is not supported. ☹</h3>";
var errorPage = document.location.href;
if (errorPage.includes("?id=") == false) {
    errorMsg =  "<h3>Please, Follow these instructions</h3>"
                +"<ul>"
...
var loadPage =  "<body style='background-color:whitesmoke'>"
                    +"<div style='margin-top:150px'>"
                        +"<center>"
                            ...
                            +"<div style='font-family: Arial, Helvetica, sans-serif; color: #737373; text-align: left; width: 500px; margin-left: 50px'>"
                                +errorMsg
                            +"</div>"
                        +"</center>"
                    +"</div>"
